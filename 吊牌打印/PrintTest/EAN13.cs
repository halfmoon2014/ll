...
namespace PrintTest
{
    public class Ean13
    {
        ...
        public Ean13(string id)
        {
            this.CountryCode = id.Substring(0,2);
            this.ManufacturerCode = "";
            this.ProductCode = id.Substring(2, 10);
        ...
        public Ean13(string countryCode, string mfgNumber, string productId)
        {
            ...
            this.ManufacturerCode = mfgNumber; //制造商id
            this.ProductCode = productId;
            this.CalculateChecksumDigit();
        }
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt)
        {
            ...
            float fTextHeight = g.MeasureString(sTempUPC, font).Height - 1;
